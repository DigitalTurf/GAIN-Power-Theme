				...
				if($postType=="listing"){
					...
					if(!empty($postReportedby)){
						...
						if(!empty($resSearch)){
							...
							$resp = '<span><i class="fas fa-check" aria-hidden="true"></i></span>'.esc_html__('Reported Successfully', 'listingpro');
    ...
    function quick_preivew_cb() {
		 $output = '';
            ...
            if($claimed_section == 'claimed') {
                $claim = '<span class="verified simptip-position-top simptip-movable" data-tooltip="'. esc_html__('Claimed', 'listingpro').'"><i class="fas fa-check"></i> '. esc_html__('Claimed', 'listingpro').'</span>';
