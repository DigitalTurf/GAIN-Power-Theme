        ...
        <div class="modal-content">
          <h5 class="modal-title">Delete Lead</h5>
            <div class="modal-body">
                <?php echo esc_html__( 'are you sure you want to delete this lead?' ); ?>
            </div>
                                        ...
                                        <div class="pull-right">
                                            <div class="lp-dot-extra-buttons">
                                                ...
                                                <ul class="lp-user-menu list-style-none">
                                                    <li><a href="#" class="edit-lead-form" href="" data-targetid="<?php echo $lid; ?>" data-lid="<?php echo $lid; ?>" data-uid="<?php echo $user_id; ?>"><i class="far fa-edit"></i><span><?php echo esc_html__( 'Edit', 'listingpro' ); ?></span></a></li>
                                                    <li><a href="#" class="lf-del lp-remove-form-field" data-targetID="<?php echo $lid; ?>" data-uid="<?php echo $user_id; ?>"><i class="fas fa-trash-alt"></i><span><?php echo esc_html__( 'Delete', 'listingpro' ); ?></span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
