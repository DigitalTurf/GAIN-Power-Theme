...
if(!function_exists('listingpro_shortcode_submit_custom')){
	function listingpro_shortcode_submit_custom($atts, $content = null) {
    ...
    extract(shortcode_atts(array(
		...
		if( $page_style == 'style2' )
		{
			...
			if ($social_show == "true" && $social_show_switch == true)
			{
				...
				if ($googleSwitch == 1) {$output .=  '<input type="hidden" class="form-control" name="google_plus" id="inputGooglePlus">';}
				...
				$output .= '<input type="hidden" class="form-control" name="medium" id="inputMedium">';
				...
				$output .= '<option>' . esc_html('Medium', 'listingpro-plugin') . '</option>';
				$output .=  '       </select>';
				$output .=  '    </div>';
			 ...
			 if ($video_show == "true" || $gallery_show == "true" || lp_theme_option('lp_featured_file_switch') || $b_logo == 1 ){
				...
				if ($fileSwitch == 1)
				{
					if ($gallery_show == "true")
					{
						$output .= '<div class="col-md-12 form-group clearfix margin-bottom-0 lp-img-gall-upload-section lplistgallery" data-quick-tip="<h2>'. esc_html__( 'Gallery', 'listingpro-plugin' ) .'</h2><img src='.$quicktip_gallery.'>" data-savedgallerysize="0" data-savedgallerysize="0" data-savedgallweight="0">
                            ...
                            <div class="media-instructions">Add multiple images to display in your listing gallery. Max filesize: 2MB</div>
				...
				if( lp_theme_option('lp_featured_file_switch') )
			   {
				$output .= '<div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage col-md-6">
												<label class="margin-top-10">' . esc_html__('Banner Image', 'listingpro-plugin') . '</label>
				...
				if ($b_logo == 1) {
					$output .= '<div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage col-md-6">
										<label class="margin-top-10">' . esc_html__('Logo', 'listingpro-plugin') . '</label>
		...
		else
		{
			...
			if ($tagline_show == "true") {
				$output .= '
													<input data-quick-tip="<p>'. esc_html__( 'this is test data for quick tip for tagline field', 'listingpro-plugin' ) .'</p>' . $quicktip_image . '" type="text" name="tagline_text" class="form-control margin-bottom-10" id="lptagline" placeholder="' . esc_html__('Tagline Example: We power progress. ', 'listingpro-plugin') . '">';
			}
			$output .= '
								</div>';
			...
			$output .= '
						...
						<div class="white-section category-selection border-bottom ' . $style_wrap . '">
							<div class="row">
								<div class="form-group ' . $style2_content_class . ' col-xs-12">';
        ...
        <div class="row">
					<div class="form-group ' . $style2_content_class . ' col-xs-12 donate-form-group">
						<label for="inputDonate">Donate Button URL</label>
						<input data-quick-tip="<h2>'. esc_html__( 'Donate Button URL', 'listingpro-plugin' ) .'</h2><p>'. esc_html__( 'Where the donate button will link to', 'listingpro-plugin' ) .'</p> type="text" class="form-control" name="donate" id="inputDonate" placeholder="' . esc_html__('http://', 'listingpro-plugin') . '">
					</div>
        </div>';
			}
		   ...
		   if ($social_show == "true" && $social_show_switch == true)
			{
				...
				<div class="form-group col-md-6 col-xs-12">
					...
					<input type="text" class="form-control" name="medium" id="inputMedium" placeholder="' . esc_html__('Your Medium URL', 'listingpro-plugin') . '">
				</div>';
			}
			$output .= '
								</div>';
		...
		if( $page_style != 'style2' )
		{
			...
			$output .='
								...
								<div class="form-group col-md-12 margin-bottom-0 preview-section-caption clearfix">';
		...
		else
		{
			...
			if( $enableCaptcha == true || !empty($privacy_policy) )
			{
				$output .='
...
add_shortcode('listingpro_submit_custom', 'listingpro_shortcode_submit_custom');
