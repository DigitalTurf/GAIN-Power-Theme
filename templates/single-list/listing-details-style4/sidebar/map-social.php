    ...
    <ul class="widget-social-icons">
        ...
        ?>
            <li class="lp-widget-social-links">
                <?php if( !empty($facebook) ): ?><a href="<?php echo $facebook; ?>" target="_blank"><i class="fab fa-facebook-f-official" aria-hidden="true"></i></a><?php endif;; ?>
                <?php if( !empty($google_plus) ): ?> <a href="<?php echo $google_plus; ?>" target="_blank"><i class="fab fa-google-plus-g-square" aria-hidden="true"></i></a><?php endif; ?>
                <?php if( !empty($twitter) ): ?> <a href="<?php echo $twitter; ?>" target="_blank"><i class="fab fa-twitter-square" aria-hidden="true"></i></a><?php endif; ?>
