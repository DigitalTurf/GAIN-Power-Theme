...
?>
<div class="lp-header-search-wrap <?php echo $lp_header_search_wrap_banner_height; ?> <?php echo $lp_header_search_wrap_set_top; ?>" style="background-image: url(<?php echo $home_banner_img ?>); height: <?php echo $banner_height; ?>px;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 hidden-xs hidden-sm">
                    <div class="lp-header-search-logo text-center"><img src="<?php echo $banner_logo['url']; ?>" alt="lp-logo"></div>
                </div>
                <?php endif; ?>
                <?php
                    $locationType = 'withip';
                ...
                <div class="col-md-12 lp_auto_loc_container">
                    <div class="lp-header-search-tagline text-center" data-locnmethod="<?php echo esc_attr($locationType); ?>"><?php echo $top_title; ?></div>
                </div>
                <?php endif; ?>
                <?php
