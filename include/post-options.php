...
$ads_durations = lp_theme_option('listings_ads_durations' );
}
...
if( $lp_multi_rating_state == 1 && !empty( $lp_multi_rating_state ) )
{
    ...
    if( !empty( $lp_multi_rating_fields_active ) && count( $lp_multi_rating_fields_active ) > 0 )
    {
...
$listingpro_settings = Array(
   ...
   Array(
	...
	Array(
		'name' => esc_html__('Donate URL', 'listingpro-plugin'),
		'id' => 'donate',
		'type' => 'text',
		'desc' => 'Your donate button URL'),
    Array(
	...
	Array(
		'name' => esc_html__('Medium Profile Link', 'listingpro-plugin'),
		'id' => 'medium',
		'type' => 'text',
		'desc' => esc_html__('Your Medium Profile URL as social link', 'listingpro-plugin'),
		),
	Array(
