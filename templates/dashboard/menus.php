    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-body">
				<?php echo esc_html__( 'are you sure you want to delete this menu?', 'listingpro'); ?>
            </div>
		...
		if( $count_m_listings == 0 ):
            ...
            <div class="lp-blank-section">
                <div class="col-md-12 blank-left-side">
                    <h1><?php echo esc_html__('You don\'t have any menus, yet!', 'listingpro'); ?></h1>
                                                ...
                                                <div class="pull-right">
                                                    <div class="lp-dot-extra-buttons">
                                                        ...
                                                        <ul class="lp-user-menu list-style-none">
                                                            <li><a href="" class="menu-edit" data-targetid="<?php echo $lid; ?>"><i class="far fa-edit"></i><span><?php echo esc_html__( 'Edit', 'listingpro'); ?></span></a></li>
                                                            <li><a href="" class="del-all-menu" data-uid="<?php echo $user_id; ?>" data-lid="<?php echo $lid; ?>"><i class="fas fa-trash-alt"></i><span><?php echo esc_html__( 'Delete', 'listingpro'); ?></span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div class="lp-menu-closed clearfix ">
                                                                            ...
                                                                            <ul class="lp-user-menu list-style-none">
                                                                                <li><a class="edit-menu-item"
                                                                                       ...
                                                                                       href=""><i class="fas fa-pencil-alt"
