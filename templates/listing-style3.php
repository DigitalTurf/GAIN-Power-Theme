...
if(have_posts()):
    ...
    while (have_posts()): the_post();
        ...
        if($claimed_section == 'claimed') {
            ...
            $claim = '<span class="claimed '. $claimed_position .'"><i class="fas fa-check"></i> '. esc_html__('Claimed', 'listingpro').'</span>';
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="" class="<?php if($favrt == 'yes'){echo 'remove-fav-v2';}else{echo 'add-to-fav-v2';} ?>" data-post-id="<?php echo get_the_ID(); ?>" data-post-type="detail">
                                            ...
                                            <i class="fa <?php if($favrt == 'yes'){echo 'fa-bookmark';}else{echo 'fa-bookmark';} ?>" aria-hidden="true"></i>
                                    ...
                                    if( !empty( $allowedReviews ) && $allowedReviews == 1 && get_post_status( $post->ID )== "publish" ):
                                        ...
                                        <li><a href="" class="review-form-toggle"><i class="far fa-star" aria-hidden="true"></i> <?php echo esc_html__('Add a Review ', 'listingpro'); ?></a></li>
...

                        {
...

                            {
                                switch ( $key )
                                {
                                    ...
                                    case 'lp_event_section':
                                        get_template_part( 'templates/single-list/listing-details-style3/sidebar/event' ) ;
                                        break;
