...
if(!function_exists('listingpro_get_reviews_form')){
	function listingpro_get_reviews_form($postid){
		if (class_exists('ListingReviews')) {
			...
			if( is_user_logged_in() )
			{
				...
				?>
					...
					<div class="review-form" id="review-section">
						<h3 id="reply-title" class="comment-reply-title"><i class="far fa-star"></i> <?php esc_html_e('Rate us and Write a Review','listingpro'); ?> <i class="fa fa-caret-down"></i></h3>
                        <form data-multi-rating="<?php echo $lp_multi_rating_state; ?>" id = "rewies_form" name = "rewies_form" action = "" method = "post" enctype="multipart/form-data" data-imgcount="<?php echo $lp_images_count; ?>" data-imgsize="<?php echo $lp_images_size; ?>" data-countnotice="<?php echo $lp_imagecount_notice;?>" data-sizenotice="<?php echo $lp_imagesize_notice; ?>">
                            <div class="form-group">
                                <label for = "relation">How are you connected to <?php the_title(); ?>?</label>
                                <select name="relation" id="relation-select">
                                    <option class="placeholder-option" value="0">--Select relation--</option>
                                    <option value="1">You managed <?php the_title(); ?> directly</option>
                                    <option value="2">You reported directly to <?php the_title(); ?></option>
                                    <option value="3">You were senior to <?php the_title(); ?></option>
                                    <option value="4">You worked with <?php the_title(); ?> in the same organization/campaign</option>
                                    <option value="5">You worked with <?php the_title(); ?> but in different organizations/campaigns</option>
                                    <option value="6">You worked with <?php the_title(); ?> but at different organizations/campaigns</option>
                                    <option value="7"><?php the_title(); ?> was a client of yours</option>
                                    <option value="8">You were a client of <?php the_title(); ?></option>
                                    <option value="9">You mentored <?php the_title(); ?></option>
                                </select>
                            </div>
							<?php
								...
								foreach( $lp_multi_rating_fields_active as $k => $lp_multi_rating_field )
								{
									...
									<div class="<?php echo $multi_col_class; ?> padding-left-0">
										<div class="sfdfdf list-style-none form-review-stars">
											...
											<input type="hidden" data-mrf="<?php echo $k; ?>" id="review-rating-<?php echo $k; ?>" name="rating-<?php echo $k; ?>" class="rating-tooltip lp-multi-rating-val" data-filled="far fa-star fa-2x" data-empty="far fa-star fa-2x" />
							...
							<div class="form-group">
								...
								<input placeholder="<?php esc_html_e('These people do excellent work','listingpro'); ?>" type = "text" id = "post_title" class="form-control" name = "post_title" />
							</div>
							<div class="form-group">
								<label for = "post_description"><?php esc_html_e('Review','listingpro'); ?></label>
								<textarea placeholder="<?php esc_html_e('This group was very effective on this effort I worked on. They were passionate, hard working, and very smart in my experience with them.','listingpro'); ?>" id = "post_description" class="form-control" rows="8" name = "post_description" ></textarea>
							...
							?>
									...
									<p class="form-submit post-reletive">
										...
										<input type="hidden" name="errormessage" value="<?php esc_html_e('Please fill Relation, Rating, Title, and Review', 'listingpro'); ?>">
            ...
            {
            ?>
                <!-- Review form for logged out users -->
				<div class="review-form">
					...
					<?php } ?>
						...
						<?php
                            ...
                            <!--<div class = "col-md-6 pull-right padding-right-0">2
                                <div class="form-group submit-images">
                                    <label for = "post_gallery submit-images"><?php esc_html_e('Select Images','listingpro'); ?></label>
                                    <a href="#" class="browse-imgs"><?php esc_html_e('Browse','listingpro'); ?></a>
                                    <input type = "file" id = "filer_input2" name = "post_gallery[]" multiple="multiple"/>
						...
						<div class="form-group">
							<label for = "post_title"><?php esc_html_e('Title','listingpro'); ?></label>
							<input type = "text" placeholder="<?php esc_html_e('These people do excellent work','listingpro'); ?>" id = "post_title" class="form-control" name = "post_title" />
						</div>
						<div class="form-group">
							<label for = "post_description"><?php esc_html_e('Review','listingpro'); ?></label>
							<textarea placeholder="<?php esc_html_e('This group was very effective on this effort I worked on. They were passionate, hard working, and very smart in my experience with them.','listingpro'); ?>" id = "post_description" class="form-control" rows="8" name = "post_description" ></textarea>
                    ...
                    <form data-multi-rating="<?php echo $lp_multi_rating_state; ?>" id = "rewies_form" name="rewies_form" action = "" method = "post" enctype="multipart/form-data" data-imgcount="<?php echo $lp_images_count; ?>" data-imgsize="<?php echo $lp_images_size; ?>" data-countnotice="<?php echo $lp_imagecount_notice;?>" data-sizenotice="<?php echo $lp_imagesize_notice; ?>">
...

                            {
                                ...
                                <div class="lp-review-stars">
                                    ...
                                    <div class="lp-listing-stars">
                                        ...
                                        <input type="hidden" id="review-rating" name="rating" class="rating-tooltip" data-filled="far fa-star" data-empty="far fa-star" />
                        ...
                        <div class="lp-review-form-bottom">
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="<?php esc_html_e('This group was very effective on this effort I worked on. They were passionate, hard working, and very smart in my experience with them. And remember.','listingpro'); ?>" id = "post_description" class="form-control" rows="8" name = "post_description" ></textarea>
                            ...
                            if( !empty( $privacy_policy ) && $privacy_review == 'yes' )
                            {
                                ...
                                <p class="form-submit post-reletive">
                                    ...
                                    <input type="hidden" name="comment_post_ID" value="<?php echo $postid; ?>" id="comment_post_ID">
                                    <input type="hidden" name="errormessage" value="<?php esc_html_e('Please Title, Review and Rating', 'listingpro'); ?>">
                                    <span class="review_status"></span>
                                    <img class="loadinerSearch" width="100px" src="<?php echo get_template_directory_uri().'/assets/images/ajax-load.gif' ?>">
                                </p>
                            <?php
...

                                    {
                                        ...
                                        <div class="lp-listing-stars">
                                            ...
                                            <input type="hidden" id="review-rating" name="rating" class="rating-tooltip"
                                                   ...
                                                   data-filled="far fa-star" data-empty="far fa-star"/>
