        ...
        <form autocomplete="off" class="clearfix" method="post" enctype="multipart/form-data" id="searchform">
            ...
            if(!empty($searchfilter) && $searchfilter=='1'){
                ...
                <div class="form-inline lp-filter-inner" id="pop">
                                                ...
                                                <div class="sortbyrated-outer">
                                                    <div class="border-dropdown sortbyrated">
                                                        ...
                                                        <ul class="comboboxCategory clearfix" id="select-lp-more-filter">
                                                            ...
                                                            <?php } ?>
                                                            <?php if($highRatOPT=="1"){ ?>
                                                                <li id="listingRate"><a href="#" data-value="listing_rate"><i class="far fa-star"></i> <?php echo esc_html__( 'Highest Rated', 'listingpro' );?></a></li>
                                                            <?php } ?>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <a href="#" class="open-map-view"><i class="fas fa-map-marked-alt"></i></a>
