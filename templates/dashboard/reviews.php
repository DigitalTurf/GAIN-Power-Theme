...
<div class="panel with-nav-tabs panel-default lp-dashboard-tabs lp-all-reviews-outer">
					...
					if(empty($recentReviews) && empty($submittedReviews)){
						...
						<div class="lp-blank-section">
							<div class="col-md-12 blank-left-side">
								<h1><?php echo esc_html__('You don\'t have any reviews, yet!', 'listingpro'); ?></h1>
						...
						if(!empty($recentReviews)){
							...
							if ( $aReviews_query->have_posts() ) {
								while ( $aReviews_query->have_posts() ) {
									...
									$authorid = (int) $aReviews_query->post->post_author;
