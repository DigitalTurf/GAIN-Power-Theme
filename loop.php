	...
	if ( have_posts() ) {
                                    ...
                                    <div class="lp-blog-grid-box-thumb">
                                        <a href="<?php the_permalink(); ?>">
																					...
																					if (has_post_thumbnail()) {
																							...
																							$size = ($blog_view == 'list_view')? '305x200' : '305x200' ;
																							$img_url = esc_html__('https://via.placeholder.com/' . $size, 'listingpro');
																					}
																					?>
																						<div class='lp-blog-grid-img' style='background-image: url("<?php echo $img_url; ?>");'></div>
                                        </a>
                                    ...
                                    <div class="lp-blog-grid-box-description text-left">
                                        ...
                                        <?php //the_excerpt();
														            ...
														            $finalexcerpt = substr($excerpt, 0, strrpos($excerpt, ' '));?>
																				<div class="lp-blog-excerpt"><?php echo $finalexcerpt .'...'; ?></div>
					...
					<div class=" lp-blog-grid-box">
							...
							<div class="lp-blog-grid-box-container lp-blog-grid-box-container-style2 lp-border-radius-8">
								...
								<div class="lp-blog-grid-box-description  lp-border lp-blog-grid-box-description2">
										<div class="lp-blog-user-thumb margin-top-subtract-25">
											<a href="<?php echo get_profile_url_by_id( get_the_author_meta( 'ID' ) ); ?>"><img class="avatar" src="<?php echo esc_url($avatar);?>" alt=""></a>
										</div>
		...
		?>
		<div class="text-center margin-top-80 margin-bottom-100 no-results">
