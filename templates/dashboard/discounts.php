        ...
        <div class="modal-content">
          <h5 class="modal-title">Delete Coupon</h5>
            <div class="modal-body">
                <?php echo esc_html__( 'Are you sure you want to delete this coupon?' ); ?>
            </div>
    ...
    if( $count_d_listings == 0 ):
        ...
        <div class="lp-blank-section">
            <div class="col-md-12 blank-left-side">
               <h1><?php echo esc_html__('You don\'t have any coupons, yet!', 'listingpro'); ?></h1>
                                            ...
                                            <div class="pull-right">
                                                <div class="lp-dot-extra-buttons">
                                                    ...
                                                    <ul class="lp-user-menu list-style-none">
                                                        <li><a href="" class="dis-edit" data-targetid="<?php echo $disID; ?>" data-disID="<?php echo $disID; ?>" data-uid="<?php echo $user_id; ?>"><i class="far fa-edit"></i><span><?php esc_html_e('Edit','listingpro'); ?></span></a></li>
                                                        <li><a href="" class="dis-del del-this" data-targetID="<?php echo $disID; ?>" data-uid="<?php echo $user_id; ?>"><i class="fas fa-trash-alt"></i><span><?php esc_html_e('Delete','listingpro'); ?></span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="clearfix">
                                                    <div class="pull-right">
                                                        <div class="lp-dot-extra-buttons">
                                                            <img src="data:image/png;base64,">
                                                            <ul class="lp-user-menu list-style-none">
                                                                <li><a href="" class="dis-edit" data-targetid="<?php echo $disID; ?>" data-disID="<?php echo $disID; ?>" data-uid="<?php echo $user_id; ?>"><i class="far fa-edit"></i><span><?php echo esc_html__( 'Edit', 'listingpro' ); ?></span></a></li>
                                                                <li><a href="" class="dis-del del-this" data-targetID="<?php echo $disID; ?>" data-uid="<?php echo $user_id; ?>"><i class="fas fa-trash-alt"></i><span><?php echo esc_html__( 'Delete', 'listingpro' ); ?></span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="lp-listing-pay-outer pull-right <?php echo $active_class; ?>">
