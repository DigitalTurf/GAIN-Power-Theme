        ...
        <section class="lp-event-detail">
            <div class="lp-event-top-title-header">
				<?php if( !empty( $event_img ) ){ ?>
                    <div class="lp-event-bgimage" style="background: url(<?php echo $event_img; ?>);"></div>
				<?php } ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="lp-event-detail-date-title-outer">
                                ...
                                <div class="lp-event-detail-title-hosted">
                                    ...
                                    <div class="lp-share-event-detail">
                                        <span class="lp-event-share-btn-st"><i class="fa fa-share-alt" aria-hidden="true"></i> <?php echo esc_html__('Share :', 'listingpro');?></span>
                                    ...
                                    <ul>
										...
										if(!empty($attending_users)){
											foreach ($attending_users as $val) {
												...
												//$author_url = get_profile_url_by_id( get_the_author_meta($user_attende->ID) );
												$avatar = '';
