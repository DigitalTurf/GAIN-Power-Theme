...

    {
        ...
        <ul>
...

            {
                ...
                echo '<li><a href="'. $fb_h .'" target="_blank"><i class="fab fa-facebook-f"></i></a></li>';
...

            {
                ...
                echo '<li><a href="'. $tw_h .'" target="_blank"><i class="fab fa-twitter"></i></a></li>';
...

            {
                ...
                echo '<li><a href="'. $gog_h .'" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>';
...

            {
                ...
                echo '<li><a href="'. $f_linked_h .'" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>';
...

            {
                ...
                echo '<li><a href="'. $f_pintereset_h .'" target="_blank"><i class="fab fa-pinterest-p"></i></a></li>';
                    ...
                    <div class="lp-listing-review">
                        ...
                        <div class="lp-review-left">
                            ...
                            <div class="lp-review-thumb">
                                <a href="<?php echo get_profile_url_by_id($author_id); ?>">
                                <img src="<?php  echo esc_attr($avatar); ?>" alt="">
                                </a>
                            </div>

                            <span class="lp-review-name"><a href="<?php echo get_profile_url_by_id($author_id); ?>"><?php the_author(); ?></a></span>

                            <span class="lp-review-count"><i class="far fa-star" aria-hidden="true"></i> <?php echo $user_reviews_count; ?> <?php esc_html_e('Reviews','listingpro'); ?></span>
                        ...
                        <div class="lp-review-right">
                                ...
                                <div class="lp-review-stars">
                                    ...
                                    <div class="lp-listing-stars">
                                        <div class="lp-rating-stars-outer">
                                            <span class="lp-star-box <?php if($rating >= 1){echo 'filled'.' '.$rating_num_clr;}?>"><i class="far fa-star" aria-hidden="true"></i></span>

                                            <span class="lp-star-box <?php if($rating >= 2){echo 'filled'.' '.$rating_num_clr;}?>"><i class="far fa-star" aria-hidden="true"></i></span>

                                            <span class="lp-star-box <?php if($rating >= 3){echo 'filled'.' '.$rating_num_clr;}?>"><i class="far fa-star" aria-hidden="true"></i></span>

                                            <span class="lp-star-box <?php if($rating >= 4){echo 'filled'.' '.$rating_num_clr;}?>"><i class="far fa-star" aria-hidden="true"></i></span>

                                            <span class="lp-star-box <?php if($rating >= 5){echo 'filled'.' '.$rating_num_clr;}?>"><i class="far fa-star" aria-hidden="true"></i></span>
                                        </div>
                                        <?php
                            ...
                            <div class="lp-review-right-content">
                                ...
                                <div class="lp-review-right-bottom">
                                    ...
                                    <a href="#" data-restype="<?php echo $interVal; ?>" data-reacted ="<?php echo $reacted_msg; ?>" data-id="<?php the_ID(); ?>" data-score="<?php echo esc_attr($interests); ?>" class="review-interesting review-reaction"><i class="far fa-thumbs-up"></i><span class="react-msg"></span> <?php esc_html_e('Interesting','listingpro'); ?> <span class="react-count"><?php echo $interests; ?></span></a>

                                    <a href="#" data-restype="<?php echo $lolVal; ?>" data-reacted ="<?php echo $reacted_msg; ?>" data-id="<?php the_ID(); ?>" data-score="<?php echo esc_attr($Lols); ?>" class="review-lol review-reaction"><i class="far fa-smile"></i> <span class="react-msg"></span> <span class="react-msg"></span><?php esc_html_e('LOL','listingpro'); ?> <span class="react-count"><?php echo $Lols; ?></span></a>

                                    <a href="#" data-restype="<?php echo $loveVal; ?>" data-reacted ="<?php echo $reacted_msg; ?>" data-id="<?php the_ID(); ?>" data-score="<?php echo esc_attr($loves); ?>" class="review-love review-reaction"><i class="far fa-heart"></i><span class="react-msg"></span> <span class="react-msg"></span><?php esc_html_e('Love','listingpro'); ?> <span class="react-count"><?php echo $loves; ?></span></a>
...

    {
        ...
        <div class="lp-listing-review">
            ...
            <div class="lp-review-left">
                ...
                <span class="lp-review-name"><a href="<?php echo get_profile_url_by_id($author_id); ?>"><?php echo $author_display_name; ?></a></span>
...

                {
...

                    {
...

                        {
                            ...
                            $value  =   '<i class="fas fa-check" aria-hidden="true"></i>';
...

{
...

    {
        ...
        <a href="" class="lp-single-sharing"><i class="fas fa-share-alt" aria-hidden="true"></i> <?php echo esc_html__('Share', 'listingpro');?></a>
