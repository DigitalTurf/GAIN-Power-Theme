...
if( !empty( $IDs )):
    ...
    <div class="lp-see-all">
        ...
        $img_url    = wp_get_attachment_image_src( $first_img, 'full');

        ?>

        <a href="<?php echo $img_url[0]; ?>" rel="prettyPhoto[gallery1]"><i class="fa fa-camera" aria-hidden="true"></i> <?php echo $numImages; ?> <?php echo esc_html__('see all', 'listingpro'); ?></a>
