<?php
class listingpro_TWRecentPostWidgetChild extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'listingpro_TWRecentPostWidgetChild', 'description' => 'listingpro recent posts.');
        parent::__construct(false, 'GP listingpro recent posts', $widget_ops);
    }
            ...
            echo '<li>';
                ...
                echo '<div class="jw-recent-content '.$class.'">';
                    ...
                    echo '<div class="meta">';
                            ...
                            echo '<span class="date">'.get_the_date( ' M. n, Y' ).'</span>';
                            ?>
...
add_action('widgets_init', 'listingpro_TWRecentPostWidgetChild_cb');
function listingpro_TWRecentPostWidgetChild_cb()
{
   register_widget( 'listingpro_TWRecentPostWidgetChild' );
}
add_action('wp_ajax_themewave_recent_post_terms', 'get_post_type_terms_child');
function get_post_type_terms_child() {
    $cat = 'post';
