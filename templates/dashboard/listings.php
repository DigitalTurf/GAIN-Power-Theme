<div class="tab-pane fade in active" id="lp-listings">
...
?>
				<div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-9 lp-left-panel-height">
					...
					?>
							...
							<div class="panel-body">
								<div class="lp-main-title clearfix">
									<div class="col-md-4 lp-first-title"><p><?php esc_html_e('title','listingpro'); ?></p></div>
									<div class="col-md-2"><p><?php esc_html_e('expiry','listingpro'); ?></p></div>
									<div class="col-md-6"><p><?php esc_html_e('status','listingpro'); ?></p></div>
								</div>
										...
										if( $listings_query->have_posts() ) {
											...
											?>
												<div class="lp-listing-outer-container clearfix ">
													<div class="col-md-4 lp-content-before-after" data-content="<?php esc_html_e('Title','listingpro'); ?>">
													...
													<div class="col-md-6 lp-content-before-after" data-content="<?php esc_html_e('Status','listingpro'); ?>">
																...
																<div class="pull-right">
																	<div class="lp-dot-extra-buttons">
																		...
																		<ul class="lp-user-menu list-style-none">
																				<li><a target="_blank" href="<?php echo esc_url($edit_post); ?>"><i class="far fa-edit"></i><span><?php echo esc_html__('Edit', 'listingpro'); ?></span></span></a></li>
					...
					<?php } else{ ?>
								...
								<div class="lp-blank-section">
									<div class="col-md-9 blank-left-side">
										<h1><?php echo esc_html__('You don\'t have any listings, yet!', 'listingpro'); ?></h1>
					...
					<a href="/pricing-plan/" class="lp-add-new-btn" ><span><i class="fa fa-plus" aria-hidden="true"></i></span> <?php echo esc_html__('Add new listing','listingpro'); ?></a>
									</div>
