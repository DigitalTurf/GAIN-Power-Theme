...
<?php
	...
	wp_nav_menu($args);
?>
<?php if(!empty($all_success)) { ?>
  <button type="button" class="lp-add-new-btn lp-add-new-btn add-new-open-form add-new-open-not-first" data-toggle="modal" data-target="#modal-lp-submit-ad"><span><i class="fa fa-plus" aria-hidden="true"></i></span> <?php echo esc_html__('Add new ad','listingpro'); ?></button>
<?php } ?>
        ...
        if(!empty($all_success)){
            ...
            <div class="panel-body lp-new-packages" id="lp-new-invoices">
                <div class="lp-main-title clearfix">
                    <div class="col-md-5"><p><?php esc_html_e('Title','listingpro'); ?></p></div>
                    ...
                    <div class="col-md-2 text-right"><p><?php esc_html_e('status','listingpro'); ?></p></div>
                </div>
                            ...
                            if(!empty($caID)){
                                ...
                                if ( get_post_status ( $caID ) ) {
                                    ...
                                    <div <?php echo $thisInvAtts;?> class="lp-listing-outer-container clearfix <?php echo $listingTID; ?>">
                                        ...
                                        <div class="col-md-5 lp-content-before-after" data-content="<?php esc_html_e('Type','listingpro'); ?>">
                                        ...
                                        <div class="col-md-2 lp-content-before-after" data-content="<?php esc_html_e('Trans ID','listingpro'); ?>">
                                        ...
                                        <div class="col-md-2 text-right lp-content-before-after" data-content="<?php esc_html_e('Status','listingpro'); ?>">
        ...
        ?>
		 ...
		 <div class="lp-blank-section" style="min-height:inherit">
            <div class="col-md-12 blank-left-side">
					<h1><?php echo esc_html__('You don\'t have any campaigns, yet!', 'listingpro'); ?></h1>
