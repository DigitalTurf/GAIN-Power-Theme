									...
									<div class="show-img">
										<?php
											...
											if (!empty($top_cat_obj)) {
												//echo '<div class="top-listing-categoty '.strtolower(str_replace(" ","-",$top_cat_obj->name)).'"><i class="fas fa-layer-group"></i>'.$top_cat_obj->name.'</div>';
											}
										?>
							...
							<div class="lp-grid-desc-container lp-border clearfix">
								<div class="lp-grid-box-description ">
									<div class="lp-grid-box-left pull-left">
										...
										<p class="description-container"><?php echo substr(strip_tags(get_the_content()),0,90) ?></p>
                                ...
                                <div class="lp-grid-box-description ">
                                    ...
                                    <div class="author-img-outer pos-relative">
                                        <div class="author-img">
                                            <a href="<?php echo get_profile_url_by_id( get_the_author_meta( 'ID' ) ); ?>"><img src="<?php echo esc_url($avatar); ?>" alt=""></a>
