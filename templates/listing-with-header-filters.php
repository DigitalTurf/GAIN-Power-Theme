                    ...
                    <div class="row">
						...
						?>
                            <ul style="float:left" id="select-lp-more-filter" class="lp-sorting-filter-outer margin-top-10 filter-in-header">
								...
								?>
                                <li id="listingRate"><a data-value="listing_rate" class="rated-filter header-filter-wrap"><i class="far fa-star" aria-hidden="true"></i> <?php esc_html_e('Highest Rated','listingpro'); ?></a></li>
								<?php
								}
								...
								?>
                                <li id="listingReviewed"><a data-value="listing_reviewed" class="reviewed-filter header-filter-wrap"><i class="far fa-edit" aria-hidden="true"></i> <?php esc_html_e('Most Reviewed','listingpro'); ?></a></li>
								<?php
								}
                    ...
                    <div class="listing-simple">
                        ...
                        <div id="content-grids" class="listing-with-header-filters-wrap <?php echo $v2_toggle; ?>">
                            ...
                            if( $my_query->have_posts() ):
                                ...
                                <div class="text-center margin-top-80 margin-bottom-80 no-results">
