<?php
	...
	$donate_show = get_post_meta( get_the_ID(), 'lp_donatebutton', true );
	if($donate_show == "true"){
		$donate_show = 'checked';
	}else{
		$donate_show = 'unchecked';
	}
					...
					<div class="<?php echo $classForBg; ?>" style="<?php echo $plan_title_bg; ?>">
										<div class="lp-plane-top-wrape">
											...
											if(!empty($post_price)){
												...
												?>
													<p><?php echo listingpro_currency_sign().$post_price; ?></p>
												<?php
												}
												else{ ?>
													<p><?php echo $post_price.listingpro_currency_sign(); ?></p>
												<?php
												}
											}
											else{ ?>
					...
					<div class="lp-price-list" style="display:block;">
							...
							?>
									...
									<ul class="lp-listprc">
											...
											if(get_post_meta(get_the_ID(), 'donate_show_hide', true)==''){
												echo '
												<li>
													<span class="icon-text">'.listingpro_icon8($donate_show).'</span>
													<span>'.esc_html__('Donate Button', 'listingpro-plugin').'</span>
												</li>
												';
											}
											if(get_post_meta(get_the_ID(), 'metacampaign_show_hide', true)==''){
												...
												<li>
													...
													<span>'.esc_html__('Hide similar listings', 'listingpro-plugin').'</span>
												</li>
												';
											}
