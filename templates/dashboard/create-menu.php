                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="lp-rigt-icons lp-list-view-content-bottom lp-all-listing-action-btns">
                                                            ...
                                                            <ul class="lp-list-view-edit list-style-none aliceblue" style="padding-top: 0;">
                                                                ...
                                                                <li><a href="#" class="menu-edit" data-menuID="<?php echo $menu_id; ?>" data-uid="<?php echo $user_id; ?>"><i class="fas fa-pencil-alt"></i><span><?php echo esc_html__('Edit', 'listingpro'); ?></span></a></li>


                                                                <li><a href="#" class="menu-del del-this" data-LID="<?php echo $lp_menu['mListing']; ?>" data-targetid="<?php echo $menu_id; ?>" data-uid="<?php echo $user_id; ?>"><i class="fas fa-times"></i><span><?php echo esc_html__('Remove', 'listingpro'); ?></span></a></li>
