...

{
...

    {
        ...
        ?>
            ...
            <?php if( $topBannerView == 'banner_view2' && ($header_views == 'header_with_topbar' || $header_views == 'header_without_topbar' || $header_views == 'header_menu_bar' ) ): ?>
            ...
            .home .lp-top-bar{
                ...
                background-color: rgba(0, 0, 0, <?php echo $top_bar_opacity; ?>);
