...
if( isset( $listingpro_options['about_me_social_icons_gp'] ) )
    $gp_show    =   $listingpro_options['about_me_social_icons_gp'];
...
<div class="author-about-wrap">
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            if( $social_show == 1 && ( $author_fb != '' || $author_tw != '' || $author_gp != '' || $author_pin != '' || $author_insta ) || $author_link !='' ):
            ?>
            <div class="info-row">
                ...
                <div class="lp-blog-grid-shares-contact-page">
                    ...
                    ?>
                    <a href="<?php echo $author_fb; ?>" class="lp-blog-grid-shares-icon icon-fb"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                    <?php endif; ?>
                    <?php
                    if( $tw_show == 1 && $author_tw != '' ):
                    ?>
                    <a href="<?php echo $author_tw; ?>" class="lp-blog-grid-shares-icon icon-tw"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                    <?php endif; ?>
                    <?php
                    if( $gp_show == 1 && $author_gp != '' ):
                    ?>
                    <a href="<?php echo $author_gp ?>" class="lp-blog-grid-shares-icon icon-gp"><i class="fab fa-google-plus-g" aria-hidden="true"></i></a>
                    <?php endif; ?>
                    <?php
                    if( $pin_show == 1 && $author_pin != '' ):
                    ?>
                    <a href="<?php echo $author_pin; ?>" class="lp-blog-grid-shares-icon icon-pin"><i class="fab fa-pinterest-p" aria-hidden="true"></i></a>
                    <?php endif; ?>
                    <?php
                    if( $insta_show == 1 && $author_insta ):
                    ?>
                    <a href="<?php echo $author_insta; ?>" class="lp-blog-grid-shares-icon icon-pin"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                    <?php endif; ?>
					
					<?php
                    if( $link_show == 1 && $author_link ):
                    ?>
                    <a href="<?php echo $author_link; ?>" class="lp-blog-grid-shares-icon icon-pin"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                    <?php endif; ?>
