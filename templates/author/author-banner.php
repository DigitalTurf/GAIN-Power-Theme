        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="lp-banner-date">
                    ...
                    <p><?php echo esc_html__( 'Joined In', 'listingpro' ); ?> <?php echo date( 'M Y', $joined ); ?></p>
                    ...
                    <div class="lp-banner-bottom-left">
                        ...
                        <ul>
                            ...
                            if( $counter_reviews == 1 ):
                                ...
                                $review_count   =   reviews_sum_against_author_listings( $object_id, 'publish' );
                            ...
                            <li class="banner-ratings">
                                ...
                                <strong><?php echo $review_count; ?></strong> <span><?php echo esc_html__( 'Reviews', 'listingpro' ); ?></span>
