<?php
					...
					if( !empty($_GET['lp_t_search']) && isset($_GET['lp_t_search'])){
	          $args['post_title_like'] = $_GET['lp_t_search'];
	        }
		...
		<div class="container page-container listing-simple <?php echo esc_attr($addClassListing); ?>">
			...
			<div class="mobile-map-space">
					...
					<div class="md-modal md-effect-3 mobilemap" id="modal-listing">
						...
						<a class="md-close mapbilemap-close"><i class="fas fa-times"></i></a>
						</div>
					</div>
					<!-- Popup Close -->
