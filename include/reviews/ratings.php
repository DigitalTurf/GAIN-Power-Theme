	...
	function listingpro_ratings_stars($metaboxID, $postID) {
		...
		if( !empty($rating) ){
								...
								while( $rating > 0 ){
													...
													if($rating < 1){
														echo '<i class="far fa-star lp-star-worst"></i>';
														$rating--;
														$blankstars--;
													}
													
													else if($rating >=1 && $rating < 2){
														echo '<i class="far fa-star lp-star-bad"></i>';
														$rating--;
														$blankstars--;
													}
													
													else if($rating >=2 && $rating < 3.5){
														echo '<i class="far fa-star lp-star-satisfactory"></i>';
														$rating--;
														$blankstars--;
													}
													
													else if($rating >=3.5 && $rating <= 5){
														echo '<i class="far fa-star lp-star-good"></i>';
														$rating--;
														$blankstars--;
													}
