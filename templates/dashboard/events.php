    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<?php echo esc_html__( 'Are you sure you want to delete this event?' ); ?>
            </div>
	...
	if( $events_count == 0 ):
        ...
        <div class="lp-blank-section">
            <div class="col-md-12 blank-left-side">
                <h1><?php echo esc_html__('You don\'t have any events, yet!', 'listingpro'); ?></h1>
                                        ...
                                        <div class="pull-left lp-pull-left-new">
                                            <div class="lp-dot-extra-buttons">
                                                ...
                                                <ul class="lp-user-menu list-style-none">
                                                    <li><a href="" class="event-edit" data-targetid="<?php echo $eID; ?>" data-disID="<?php echo $eID; ?>" data-uid="<?php echo $user_id; ?>"><i class="far fa-edit"></i><span><?php esc_html_e('Edit','listingpro'); ?></span></a></li>
                                                    <li><a href="#" class="del-this event-del" data-uid="<?php echo $user_id; ?>" data-lid="<?php echo $eLID; ?>" data-eid="<?php echo $eID; ?>" data-targetid="<?php echo $eID; ?>"><i class="fas fa-trash-alt"></i><span><?php esc_html_e('Delete','listingpro'); ?></span></a></li>
                                                </ul>
                                            </div>
                                        </div>
