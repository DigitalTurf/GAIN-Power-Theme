                        ...
                        foreach ( $menu_types_data as $k => $menu_type ):
                            ...
                            <div class="lp-listing-outer-container clearfix lp-coupon-outer-container">
                                ...
                                <div class="col-md-1 text-center maring-top8">
                                    <span class="del-group-type del-type del-this" data-uid="<?php echo $user_id; ?>" data-targetid="<?php echo $k; ?>"><i class="fas fa-trash-alt"></i> </span>
                                </div>
                    ...
                    if( $menu_groups_data && is_array( $menu_groups_data ) && !empty( $menu_groups_data ) ):
                        foreach ( $menu_groups_data as $k => $menu_group ):
                            ...
                            <div class="lp-listing-outer-container clearfix lp-coupon-outer-container">
                                ...
                                <div class="col-md-1 text-center maring-top8">
                                    <span class="del-group-type del-group del-this" data-uid="<?php echo $user_id; ?>" data-targetid="<?php echo $k; ?>"><i class="fas fa-trash-alt"></i> </span>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <?php
