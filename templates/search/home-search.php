		...
		<div class="lp-search-bar">
			...
			<?php } ?>
			<form autocomplete="off"  action="<?php echo home_url(); ?>" method="get" accept-charset="UTF-8">
				...
				<div class="form-group search-switcher">
					<div class="pos-relative">
						<div class="what-placeholder pos-relative" data-holder="">
					...
					<?php
						if( isset($lp_what_field_switcher) && $lp_what_field_switcher==0 && false ){
					?>
					<div class="form-group lp-suggested-search search-cat <?php echo esc_attr($hideWhereClass); ?> <?php echo esc_attr($hideWhatClass); ?>">

					<div class="input-group-addon lp-border"><?php esc_html_e('Category','listingpro'); ?></div>
						<div class="pos-relative">
							<div class="what-placeholder pos-relative" data-holder="">
